	...
	SubShader
	{
		...
		Pass
		{
						...
						)
			{
				...
				float2 uv1_FurMap186 = packedInput.uv1.xy;
				...
				float3 switchResult80 = (((isFrontFace>0)?(NormalMap62):(( 1.0 - NormalMap62 ))));
				
				surfaceDescription.BaseColor = ( ( _AlbedoTint * lerpResult92 * lerpResult96 * ( tex2DNode1 + ( 1.0 - _AlbedoPower ) ) ) + ( max( temp_output_53_0 , float4( 0,0,0,0 ) ) * _SpecularAdditive ) ).rgb;
				surfaceDescription.Normal = switchResult80;
				...
				surfaceDescription.Smoothness = ( temp_output_53_0 * _SmoothMult ).r;
		...
		Pass
		{
			...
			float4 Frag(PackedVaryingsMeshToPS packedInput  ) : SV_Target
			{
				...
				BuiltinData builtinData;
				GlobalSurfaceDescription surfaceDescription = (GlobalSurfaceDescription)0;
				float2 uv1_FurMap186 = packedInput.ase_texcoord2.xy;
				float4 tex2DNode86 = tex2D( _FurMap1, uv1_FurMap186 );
				float clampResult90 = clamp( ( ( 1.0 - tex2DNode86.a ) + ( 1.0 - ( tex2DNode86.b * _IDPower ) ) ) , 0.0 , 1.0 );
				float4 lerpResult92 = lerp( _ID , float4( 1,1,1,1 ) , clampResult90);
				float4 lerpResult96 = lerp( _RootColor , _TipColor , tex2DNode86.a);
				float2 uv_AlbedoRGBOpacityA1 = packedInput.ase_texcoord2.zw;
				float4 tex2DNode1 = tex2D( _AlbedoRGBOpacityA, uv_AlbedoRGBOpacityA1 );
				float2 uv_Specular4 = packedInput.ase_texcoord2.zw;
				float2 uv_Normal45 = packedInput.ase_texcoord2.zw;
				float3 unpack45 = UnpackNormalScale( tex2D( _Normal, uv_Normal45, float2( 0,0 ), float2( 0,0 ) ), _NormalAmount );
				unpack45.z = lerp( 1, unpack45.z, saturate(_NormalAmount) );
				float3 NormalMap62 = unpack45;
...
Node;AmplifyShaderEditor.RangedFloatNode;25;-2303.304,176.503;Float;False;Property;_AnisotropyOffset;Anisotropy Offset;11;0;Create;True;0;0;0;False;0;False;-1;-1;-1;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;3;-1599.799,508.6237;Float;False;Property;_AnisotropyFalloff;Anisotropy Falloff;10;0;Create;True;0;0;0;False;0;False;64;64;1;256;0;1;FLOAT;0
Node;AmplifyShaderEditor.SinOpNode;30;-1430.901,254.2025;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.ColorNode;43;-1315.204,-195.798;Float;False;Property;_SpecularTint;Specular Tint;7;0;Create;True;0;0;0;False;0;False;1,1,1,1;1,1,1,1;False;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.ColorNode;93;-1774.795,-967.1556;Inherit;False;Property;_ID;ID;13;0;Create;True;0;0;0;False;0;False;1,1,1,1;1,1,1,1;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.RangedFloatNode;94;-2554.468,-908.6742;Inherit;False;Property;_IDPower;ID Power;14;0;Create;True;0;0;0;False;0;False;0;0;0;3;0;1;FLOAT;0
Node;AmplifyShaderEditor.SamplerNode;4;-1387.158,-9.735434;Inherit;True;Property;_Specular;Specular;6;2;[NoScaleOffset];[SingleLineTexture];Create;True;0;0;0;False;0;False;-1;None;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.ColorNode;97;-1667.532,-1505.845;Inherit;False;Property;_RootColor;Root Color;15;0;Create;True;0;0;0;False;0;False;1,1,1,1;1,1,1,1;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.ColorNode;98;-1669.981,-1329.074;Inherit;False;Property;_TipColor;Tip Color;16;0;Create;True;0;0;0;False;0;False;1,1,1,1;1,1,1,1;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.SamplerNode;1;-1346.8,-585.2773;Inherit;True;Property;_AlbedoRGBOpacityA;Albedo (RGB) Opacity (A);1;2;[NoScaleOffset];[SingleLineTexture];Create;True;0;0;0;False;0;False;-1;None;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RangedFloatNode;99;-1354.93,-369.7357;Inherit;False;Property;_AlbedoPower;Albedo Power;2;0;Create;True;0;0;0;False;0;False;1;1;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;47;-4306.828,48.32429;Float;False;Property;_NormalAmount;Normal Amount;4;0;Create;True;0;0;0;False;0;False;1;1;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.SamplerNode;45;-4087.228,-52.64075;Inherit;True;Property;_Normal;Normal;3;3;[NoScaleOffset];[Normal];[SingleLineTexture];Create;True;0;0;0;False;0;False;-1;None;None;True;0;True;bump;Auto;True;Object;-1;Derivative;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RangedFloatNode;72;-152.7873,-329.3844;Inherit;False;Property;_Metallic;Metallic;5;0;Create;True;0;0;0;False;0;False;0;0.1;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;103;-822.1902,-347.4247;Inherit;False;Property;_SpecularAdditive;Specular Additive;8;0;Create;True;0;0;0;False;0;False;0;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;73;-715.5737,-178.9113;Inherit;False;Property;_SmoothMult;Smooth Mult;9;0;Create;True;0;0;0;False;0;False;0;0;0;5;0;1;FLOAT;0
...
WireConnection;107;4;72;0
WireConnection;107;7;79;0
WireConnection;107;9;1;4
ASEEND*/
//CHKSM=2F8E079DEDC591CFBD0D012C6C472B0DAF1B87EE