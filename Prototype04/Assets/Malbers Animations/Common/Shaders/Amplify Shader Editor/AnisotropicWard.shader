	...
	SubShader
	{
		...
		Pass
		{
						...
						)
			{
				...
				surfaceDescription.BaseColor = ( tex2D( _Albedo, UV95 ) * _AlbedoTint ).rgb;
				...
				surfaceDescription.Smoothness = ( ( tex2D( _Specular, UV95 ) * _SpecularTint ) * ( exp( ( ( ( ( HX68 * HX68 ) + ( HY41 * HY41 ) ) / ( NdotH30 + 1.0 ) ) * -2.0 ) ) * max( NdotL27 , 0.0 ) ) ).r;
...
WireConnection;97;1;25;0
WireConnection;97;7;63;0
ASEEND*/
//CHKSM=E6D4F23C463B9887CD9BA1387C64EBBB2A8DF25D