	...
	SubShader
	{
		...
		Pass
		{
					...
					)
			{
				...
				float4 clampResult348 = clamp( ( pow( (( ( tex2D( _Gradient, texCoord256 ) + _GradientColor ) + ( 1.0 - _GradientIntensity ) )*_GradientScale + _GradientOffset) , temp_cast_0 ) + ( 1.0 - (temp_output_329_0).a ) ) , float4( 0,0,0,0 ) , float4( 1,1,1,1 ) );
...
ASEEND*/
//CHKSM=B0607F9A140E69CFB3964E34B875A9F9B096FEBE