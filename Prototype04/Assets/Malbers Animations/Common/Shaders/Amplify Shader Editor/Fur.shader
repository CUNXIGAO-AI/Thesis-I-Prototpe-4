	...
	SubShader
	{
		...
		Pass
		{
						...
						)
			{
				...
				float temp_output_50_0 = ( ( pow( saferPower48 , _AnisotropyFalloff ) * tex2D( _FurMap2, uv1_FurMap212 ).r ) * nDotL38 );
				
				float2 uv_Emission58 = packedInput.ase_texcoord5.xy;
				
				surfaceDescription.BaseColor = ( ( lerpResult129 * ( ( tex2D( _Albedo, uv_Albedo1 ) * _Tint ) * clampResult96 * lerpResult112 ) ) + ( _SpecularPower * temp_output_50_0 ) ).rgb;
				surfaceDescription.Normal = FurNormal136;
				...
				surfaceDescription.Emission = ( tex2DNode4.b * ( ( tex2D( _Emission, uv_Emission58 ) * _Emissive ) * _EmmisionPower ) ).rgb;
				surfaceDescription.Smoothness = ( temp_output_50_0 * _AnisotropyPower );
		...
		Pass
		{
			...
			float4 Frag(PackedVaryingsMeshToPS packedInput  ) : SV_Target
			{
				...
				float4 tex2DNode4 = tex2D( _FurMap1, uv1_FurMap14 );
				float4 lerpResult129 = lerp( _RootColor , _TipColor , tex2DNode4.a);
				float2 uv_Albedo1 = packedInput.ase_texcoord2.zw;
				float4 color92 = IsGammaSpace() ? float4(1,1,1,1) : float4(1,1,1,1);
				float4 lerpResult91 = lerp( _AO , color92 , packedInput.ase_color.r);
				float4 temp_cast_0 = (_AOExp).xxxx;
				float4 clampResult96 = clamp( pow( ( lerpResult91 + ( 1.0 - _AOPower ) ) , temp_cast_0 ) , float4( 0,0,0,0 ) , float4( 1,1,1,0 ) );
				float clampResult116 = clamp( ( ( 1.0 - tex2DNode4.a ) + ( 1.0 - ( tex2DNode4.b * _IDPower ) ) ) , 0.0 , 1.0 );
				float4 lerpResult112 = lerp( _ID , float4( 1,1,1,1 ) , clampResult116);
				float2 uv1_FurNormal72 = packedInput.ase_texcoord2.xy;
				float3 unpack72 = UnpackNormalScale( tex2D( _FurNormal, uv1_FurNormal72 ), _NormalPowerFur );
				unpack72.z = lerp( 1, unpack72.z, saturate(_NormalPowerFur) );
				float2 uv_BodyNormal5 = packedInput.ase_texcoord2.zw;
				float3 unpack5 = UnpackNormalScale( tex2D( _BodyNormal, uv_BodyNormal5 ), _NormalPowerBody );
				unpack5.z = lerp( 1, unpack5.z, saturate(_NormalPowerBody) );
				float3 lerpResult74 = lerp( unpack72 , unpack5 , float3( 0.5,0.5,0.5 ));
				float3 FurNormal136 = lerpResult74;
				...
				float nDotH40 = dotResult39;
				float saferPower48 = abs( max( sin( radians( ( ( _AnisotropyOffset + nDotH40 ) * 180.0 ) ) ) , 0.0 ) );
				float2 uv1_FurMap212 = packedInput.ase_texcoord2.xy;
				float dotResult25 = dot( PixelNormalWorld24 , LightDirection33 );
				float nDotL38 = dotResult25;
				float temp_output_50_0 = ( ( pow( saferPower48 , _AnisotropyFalloff ) * tex2D( _FurMap2, uv1_FurMap212 ).r ) * nDotL38 );
				
				float2 uv_Emission58 = packedInput.ase_texcoord2.zw;
...
Node;AmplifyShaderEditor.CommentaryNode;105;310.1804,-131.5493;Inherit;False;1188.391;498.2753;Emission;6;110;109;57;58;108;156;;1,1,1,1;0;0
...
Node;AmplifyShaderEditor.SamplerNode;58;360.1804,-81.54932;Inherit;True;Property;_Emission;Emission;10;2;[NoScaleOffset];[SingleLineTexture];Create;True;0;0;0;False;0;False;-1;None;18c3535150e2e784c919888af870bdf7;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RangedFloatNode;99;819.549,-1564.76;Inherit;False;Property;_AOExp;AO Exp;7;0;Create;True;0;0;0;False;0;False;0;0.53;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;95;268.0505,-1491.325;Inherit;False;Property;_AOPower;AO Power;6;0;Create;True;0;0;0;False;0;False;0;0.821;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;41;-2138.492,1169.943;Float;False;Property;_AnisotropyOffset;Anisotropy Offset;23;0;Create;True;0;0;0;False;0;False;-1;-0.19;-1;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;8;-979.6755,400.8667;Float;False;Property;_NormalPowerBody;Normal Power Body;15;0;Create;True;0;0;0;False;0;False;0;1;-3;3;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;76;-967.9581,152.3183;Float;False;Property;_NormalPowerFur;Normal Power Fur;16;0;Create;True;0;0;0;False;0;False;0;0.4;-3;3;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.SamplerNode;1;-64.162,-601.5174;Inherit;True;Property;_Albedo;Albedo;1;2;[NoScaleOffset];[SingleLineTexture];Create;True;0;0;0;False;1;Header(Albedo);False;-1;None;2b2e83183e90b0a4ca38e9a2fd74a7e6;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SamplerNode;4;-572.458,-140.7085;Inherit;True;Property;_FurMap1;Fur Map1 (A Height ID Root);20;2;[NoScaleOffset];[SingleLineTexture];Create;False;0;0;0;False;0;False;-1;None;e8625ff6ce730794686b29883756de6a;True;1;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.SamplerNode;72;-679.255,152.3974;Inherit;True;Property;_FurNormal;Fur Normal;14;3;[NoScaleOffset];[Normal];[SingleLineTexture];Create;True;0;0;0;False;0;False;-1;None;f4221c07b1dede34b954d2c6fe691b2e;True;1;True;bump;Auto;True;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RangedFloatNode;100;2679.085,-471.1767;Inherit;False;Property;_AlphaClip;Alpha Clip;0;0;Create;True;0;0;0;False;0;False;0.5;0.2;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;104;965.0837,1404.875;Inherit;False;Property;_AnisotropyPower;Anisotropy Power;24;0;Create;True;0;0;0;False;0;False;0;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.SamplerNode;12;271.1712,942.56;Inherit;True;Property;_FurMap2;Fur Map1 (Spec AO Trans);21;2;[NoScaleOffset];[SingleLineTexture];Create;False;0;0;0;False;0;False;-1;None;3266293f1a6b54742a31b7957b040261;True;1;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.RangedFloatNode;44;-8.747349,1232.116;Float;False;Property;_AnisotropyFalloff;Anisotropy Falloff;22;0;Create;True;0;0;0;False;1;Header(Anisotropy);False;64;16;1;256;0;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;108;1156.387,26.41525;Inherit;True;2;2;0;FLOAT;0;False;1;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.RegisterLocalVarNode;136;1217.938,457.799;Inherit;False;FurNormal;-1;True;1;0;FLOAT3;0,0,0;False;1;FLOAT3;0
Node;AmplifyShaderEditor.RangedFloatNode;151;2146.152,335.1276;Inherit;False;Property;_AnisotropyHD;Anisotropy HD;18;0;Create;True;0;0;0;False;0;False;0;0.3;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;18;1842.757,-243.3026;Float;False;Property;_SpecularPower;Specular Power;19;0;Create;True;0;0;0;False;0;False;0;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;109;641.3553,167.4569;Float;False;Property;_EmmisionPower;Emmision Power;11;0;Create;True;0;0;0;False;0;False;0;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;55;2166.229,245.284;Inherit;False;Property;_Metallic;Metallic;17;0;Create;True;0;0;0;False;0;False;0;0;0;1;0;1;FLOAT;0
...
WireConnection;140;4;55;0
WireConnection;140;6;108;0
WireConnection;140;7;102;0
WireConnection;140;9;4;1
ASEEND*/
//CHKSM=D28CB092784C74537F205C83686462A1ABCA250E